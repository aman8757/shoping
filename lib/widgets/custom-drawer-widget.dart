          ...
          children: [
            Padding(
              ...
              child: ListTile(
                ...
                title: Text("adbr",style: TextStyle(color: AppConstant.appTextColor),),
                subtitle: Text("version 1.0.1",style: TextStyle(color: AppConstant.appTextColor)),
                leading: CircleAvatar(radius: 22.0,
                backgroundColor: AppConstant.appMainColor,
                child: Text("A",style: TextStyle(color: AppConstant.appTextColor)),),
                
              ),
            ),
            Divider(indent: 10.0, endIndent: 10.0,thickness: 1.5,
            color: Colors.grey
            ),
             Padding(
